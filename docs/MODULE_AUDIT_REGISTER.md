...
- Final 0.46.2 release-gate regression after Oracle, Metadata, Studio HTTP framing, capability execution containment, and review-thread hardening: `python -m pytest -q` — **1322 passed, 3 skipped**.

...
assurance path: 81 lane-specific and 56 cross-cutting conditions. They do not
mean every project executes 137 tests; observations scale with approved scope.

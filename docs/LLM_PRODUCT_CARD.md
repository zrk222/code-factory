...
assurance path: 81 lane-specific and 60 cross-cutting conditions. They do not
mean every project executes 141 tests; observations scale with approved scope.

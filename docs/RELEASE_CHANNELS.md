...
Code Factory core v0.46.6, FactoryLine for VS Code/Open VSX v0.9.9, and
...
| --- | --- | --- | --- |
| GitHub | Source tag, wheel, sdist, VSIX, JetBrains ZIP, media | Publish core tag `v0.46.6`; `publish.yml` attaches the verified bundle | Public release URL and green workflow |
| PyPI | `factoryline-code-factory==0.46.6` | Trusted Publishing from `publish.yml` | PyPI project version and attestation |
...
| VS Code / Open VSX | `factoryline-vscode-0.9.9.vsix` | Web Marketplace upload for Microsoft; protected publisher workflows publish the immutable, verified VSIX to Open VSX when their scoped credentials are configured | Installable VSIX and public marketplace version |

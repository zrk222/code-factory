...
Code Factory v0.23.2 publishes one verified source state through channel-specific
...
| --- | --- | --- | --- |
| GitHub | Source tag, wheel, sdist, VSIX, JetBrains ZIP, media | Publish `v0.23.2`; `publish.yml` attaches the verified bundle | Public release URL and green workflow |
| PyPI | `factoryline-code-factory==0.23.2` | Trusted Publishing from `publish.yml` | PyPI project version and attestation |

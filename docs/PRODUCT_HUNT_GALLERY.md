...
- GitHub release: `https://github.com/zrk222/code-factory/releases/tag/v0.33.0`
- PyPI: `https://pypi.org/project/factoryline-code-factory/0.33.0/`
...
create or schedule a new launch merely to satisfy an asset-update task.

Official guidance: [Preparing for your Product Hunt launch](https://www.producthunt.com/launch/preparing-for-launch).

...
Proof 0.8.18 across the current Code Factory listing,
...
![FactoryLine logo: a blue FactoryLine mark with a green verification check](assets/factoryline-logo-480.png)
...
## 4. FactoryLine AI Proof 0.8.18: complete IDE controls
...
## 5. FactoryLine AI Proof 0.8.18: local IDE proof

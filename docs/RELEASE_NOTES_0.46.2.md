...
The current senior runtime-assurance source contains 81 lane-specific and 55 cross-cutting
rejection conditions. This is a reproducible source inventory,
not a claim that every project executes 136 tests; observations scale with the

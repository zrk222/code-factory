...
**6 mandatory audit lanes. 137 coded rejection conditions. One human-owned release decision.**

The source inventory comprises **81 lane-specific and 56 cross-cutting** conditions:
...
| Cross-cutting contract, policy, provenance, evidence and execution integrity | 56 |
| **Total** | **137** |
...
This is a source inventory, not a claim that every project executes 137 tests.

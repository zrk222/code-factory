...
Use the strict [0.9.5 compliance checklist](JETBRAINS_MARKETPLACE_COMPLIANCE_0_9_5.md)
...
3. Create the immutable tag matching the plugin version, currently
   `jetbrains-v0.9.5` after the remaining Marketplace metadata review is clear.

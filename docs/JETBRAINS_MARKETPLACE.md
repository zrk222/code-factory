...
The release candidate also carries a concise [JetBrains reviewer summary](JETBRAINS_REVIEWER_SUMMARY_0_9_4.md)
...
Use the strict [0.9.4 compliance checklist](JETBRAINS_MARKETPLACE_COMPLIANCE_0_9_4.md)
...
3. Create the immutable tag matching the plugin version, currently
   `jetbrains-v0.9.4` after the remaining Marketplace metadata review is clear.

...
It does not upload the workspace, impersonate an approval, certify a release,
or make an IntelliJ claim. A JetBrains adapter is a separate future project.

## Install

1. Install FactoryLine: `pip install factoryline-code-factory==0.12.0`.

...
from .review_audits import ReviewAuditError, audit_code, audit_fingerprint, security_scan
...
def _dispatch(argv=None) -> int:
    ...
    code_audit.add_argument("tool", choices=["patterns", "guard-paths", "all", "fingerprint", "security"])

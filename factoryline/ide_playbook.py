...
PLAYBOOK = (
 {"id":"quality_harness","when":"Substantial full-stack code or a product-facing UI is being built, refactored, or prepared for release review.","use":"Full-Stack Code & UX Harness","outcome":"bound architecture, production, accessibility, interaction and ethical-UX evidence plus six human judgments; not certification","next":"factory quality-harness template --ui --out .factory/quality-harness/manifest.json"},
 ...
 {"id":"release_decision","when":"Before interpreting a failed local release check or inspecting an external provider.","use":"Release Decision Card","outcome":"local workflow diagnosis or one named-feature decision route; provider state stays explicitly unobserved","next":"factory.release_decision"},

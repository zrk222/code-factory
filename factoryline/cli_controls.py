...
def add_parser(sub: Any) -> None:
    ...
    manifest = controls_sub.add_parser(
    ...
    evaluate = controls_sub.add_parser(
    ...
    exception = controls_sub.add_parser(
    ...
    dossier = controls_sub.add_parser(
    ...
    projection = controls_sub.add_parser(

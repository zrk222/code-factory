...
- [x] T7 | slice=docs | files=docs/SAVINGS_TRACKER.md,docs/RELEASE_HISTORY_0.20-0.23.1.md | verify=`python -m pytest -q tests/test_publication_metadata.py` | Document paired evidence semantics and the v0.22.0 release.

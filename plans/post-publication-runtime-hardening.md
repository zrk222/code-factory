...
- [ ] T3 | slice=.github | files=.github/workflows,tests/test_ci_platform_parity.py | verify=`python -m pytest -q tests/test_ci_platform_parity.py` | Add native Linux and macOS parity receipts without changing the Windows contract.

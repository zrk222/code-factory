...
- [ ] T5 | slice=docs | files=docs/PROOF_REUSE.md,docs/RELEASE_HISTORY_0.20-0.23.1.md | verify=`python -m pytest -q tests/test_proof_reuse.py tests/test_publication_metadata.py` | Document governance, CLI, exact savings, and release behavior.

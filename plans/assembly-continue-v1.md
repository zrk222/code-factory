...
- [ ] T8 | slice=docs | files=docs/ASSEMBLY_CONTINUE.md,docs/RELEASE_HISTORY_0.20-0.23.1.md,docs/CODEX_USAGE_SAMPLE.md,docs/CODEX_USAGE_SAMPLE.json | verify=`python -m pytest -q tests/test_publication_metadata.py` | Document state-aware continuation and publish the privacy-safe usage sample.

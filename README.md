...
```bash
pip install factoryline-code-factory==0.10.5
...
```bash
pip install factoryline-code-factory==0.10.5 code-factory-1-spec==0.5.0 code-factory-2-forge==0.10.1 code-factory-3-compile==0.5.2 code-factory-4-design==0.7.1
```
